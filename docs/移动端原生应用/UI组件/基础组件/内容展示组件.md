...
官方提供的插件[@nativescript/auto-fit-text](https://github.com/NativeScript/plugins/tree/main/packages/auto-fit-text)可以让我们的长文本自动换行,在不在乎样式的场合就相当实用,它可以作为原生`TextView`的补充.用法就是
