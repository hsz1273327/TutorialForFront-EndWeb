...
declare class NSArray<ObjectType> extends NSObject implements CKRecordValue, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding {
	...
	vv_containsDuplicateJSONItems(): boolean;

	vv_containsObjectTypeStrict(object: any): boolean;

	vv_isJSONEqualToArray(otherArray: NSArray<any> | any[]): boolean;
...
declare class NSCharacterSet extends NSObject implements NSCopying, NSMutableCopying, NSSecureCoding {
	...
	static ASCIICharacterSet(): NSCharacterSet;
...
declare class NSDictionary<KeyType, ObjectType> extends NSObject implements NSCopying, NSFastEnumeration, NSFastEnumeration, NSFetchRequestResult, NSMutableCopying, NSSecureCoding {
	...
	ds_deepMutableCopy(): NSMutableDictionary<any, any>;
	...
	vv_isJSONEqualToDictionary(otherDictionary: NSDictionary<any, any>): boolean;
...
declare class NSError extends NSObject implements NSCopying, NSSecureCoding {
	...
	static vv_JSONSchemaErrorWithCodeFailingObject(code: DSJSONSchemaErrorCode, failingObject: any): NSError;

	static vv_JSONSchemaErrorWithCodeFailingObjectUnderlyingError(code: DSJSONSchemaErrorCode, failingObject: any, underlyingError: NSError): NSError;

	static vv_JSONSchemaValidationErrorWithFailingValidatorReasonContext(failingValidator: DSJSONSchemaValidator, failureReason: string, validationContext: DSJSONSchemaValidationContext): NSError;
...
declare class NSNumber extends NSValue implements CKRecordValue, NSFetchRequestResult {
	...
	ds_isBoolean(): boolean;

	ds_isFloat(): boolean;

	ds_isInteger(): boolean;

	ds_isStrictEqualToNumber(otherNumber: number): boolean;
...
declare class NSString extends NSObject implements CKRecordValue, CNKeyDescriptor, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding {
	...
	static vv_JSONPointerStringFromPathComponents(pathComponents: NSArray<string> | string[]): string;
	...
	stringByEncodingNonASCIICharacters(): string;
	...
	vv_stringByDecodingAsJSONPointer(): string;

	vv_stringByEncodingAsJSONPointer(): string;
...
declare class NSURL extends NSObject implements NSCopying, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, QLPreviewItem {
	...
	vv_URIByAppendingFragmentComponent(fragmentComponent: string): this;

	vv_isNormalized(): boolean;

	vv_normalizedURI(): this;
}
